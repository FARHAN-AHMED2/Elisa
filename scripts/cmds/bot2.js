...
        "Boss Farhan er chipay😜 ",
        "bashi dakle boss Farhan ke bole dimu😒 ",
...
        "অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস Farhan কে-🐸😾🔪 ",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏 ",
        "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস Farhan ধরতে পারছে না-🐸🥲 ",
...
    }
  if ((event.body.toLowerCase() == "hedar bot") || (event.body.toLowerCase() == "baler bot") || (event.body.toLowerCase() == "sawwar bot") || (event.body.toLowerCase() == "karap bot")) {
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("𝐇𝐢.𝐇𝐞𝐥𝐥𝐨. 𝐚𝐢𝐬𝐨𝐛 𝐧𝐚 𝐤𝐨𝐫𝐞 Farhan 𝐫𝐞 𝐩𝐨𝐭𝐚𝐢𝐭𝐞 𝐨 𝐭𝐨 𝐩𝐚𝐫𝐨𝐬😫🌊", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "jibon") || (event.body.toLowerCase() == "priyansh rajput") || (event.body.toLowerCase() == "priyansh") || (event.body.toLowerCase() == "Ayan vhai")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞ 𝗙𝗔𝗥𝗛𝗔𝗡_𝗔𝗛𝗠𝗘𝗗 ☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖  𝐅𝐀𝐑𝐇𝐔🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 𝐧𝐚𝐦𝐞🤓:- ☞ F A R H A N シ︎\n👋For Any Kind Of Help Contact 👉 01797281843", threadID);
   };
